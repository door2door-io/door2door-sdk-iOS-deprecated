...
extension TripEvent {
    ...
    // ------------------------------------------------------------------------------------------
    public class func tripBeginEvent(modesOfTransportation: [ModesOfTransportation],
                                     departureTime: Date?,
        ...
        return TripEvent(action: .begin, trip: trip)
    }
    ...
    // ------------------------------------------------------------------------------------------
    @objc public class func tripBeginEvent(modesOfTransportation: [NSNumber],
                                           departureTime: Date?,
                                           originLatitude: Double,
                                           originLongitude: Double,
                                           originName: String?,
