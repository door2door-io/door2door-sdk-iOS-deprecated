...
extension TripEvent {
    ...
    // ------------------------------------------------------------------------------------------
    public class func tripBookEvent(modesOfTransportation: [ModesOfTransportation],
                                    departureTime: Date?,
        ...
        return TripEvent(action: .book, trip: trip)
    }
    ...
    // ------------------------------------------------------------------------------------------
    @objc public class func tripBookEvent(modesOfTransportation: [NSNumber],
                                          departureTime: Date?,
                                          originLatitude: Double,
                                          originLongitude: Double,
                                          originName: String?,
