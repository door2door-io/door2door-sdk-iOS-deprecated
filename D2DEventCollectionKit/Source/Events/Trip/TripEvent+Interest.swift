...
extension TripEvent {
    ...
    // ------------------------------------------------------------------------------------------
    public class func tripInterestEvent(modesOfTransportation: [ModesOfTransportation],
                                        departureTime: Date?,
        ...
        return TripEvent(action: .interest, trip: trip)
    }
    ...
    // ------------------------------------------------------------------------------------------
    @objc public class func tripInterestEvent(modesOfTransportation: [NSNumber],
                                              departureTime: Date?,
                                              originLatitude: Double,
                                              originLongitude: Double,
                                              originName: String?,
